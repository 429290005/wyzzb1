...
import com.song.zzb.wyzzb.widget.layout.RegisterPageLayout;
import com.song.zzb.wyzzb.widget.layout.SendMsgDialogLayout;
...
//			query.addWhereEqualTo("systemflag", imei);
...
//					ToastUtil.showToast(getContext(),s+"一个手机号只能在一台手机上登录哦！！");
//				}
//			});
