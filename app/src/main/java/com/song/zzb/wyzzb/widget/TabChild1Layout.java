 ...
 */
public class TabChild1Layout extends LinearLayout {
    ...
    public TabChild1Layout(Context context) {
        this(context, null);
    }

    public TabChild1Layout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TabChild1Layout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        setOrientation(HORIZONTAL);
        inflate(context, R.layout.layout_tab_child1, this);
