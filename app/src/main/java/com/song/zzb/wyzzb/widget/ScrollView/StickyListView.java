package com.song.zzb.wyzzb.widget.ScrollView;

/**
 * Created by song on 2017/5/7.
 */
...
import com.song.zzb.wyzzb.fragment.Child2Fragment.StickyScrollCallBack;
        ...
        public void onScroll(AbsListView view, int firstVisibleItem,
            ...
            if (firstVisibleItem == 0) {
                ...
                if (null != firstView) {
                    ...
                    if (firstTop < -Child2Fragment.STICKY_HEIGHT1) {
                        firstTop = -Child2Fragment.STICKY_HEIGHT1;
                    }
                    scrollCallBack.onScrollChanged(firstTop);
                }
            }
            else if (firstVisibleItem < 6) {
                scrollCallBack.onScrollChanged(-Child2Fragment.STICKY_HEIGHT1);
            }
        }
    ...
    private void animScrollY() {
        ...
        if (getFirstVisiblePosition() == 0) {
            ...
            if (firstView != null) {
                ...
                if (firstTop < -Child2Fragment.STICKY_HEIGHT1 / 2) {
                    offsetDistance = -Child2Fragment.STICKY_HEIGHT1;
                }
            }
