...
public class TitleLayout {
	...
	static LinearLayout create(Context context, boolean isSearch) {
		...
		topLine.setBackgroundColor(Color.parseColor("#ffffffff"));
		...
		bottomLine.setBackgroundColor(Color.parseColor("#ffffffff"));
	...
	private static void createNormal(LinearLayout titleLayout, Context context) {
		...
		inLayout.setBackgroundColor(Color.parseColor("#ffffffff"));
