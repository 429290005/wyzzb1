...
public class StickyScrollView extends ScrollView {
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        if (null != scrollCallBack) {
            ...
            if (t > Child2Fragment.STICKY_HEIGHT1) {
                stickyTranslate = Child2Fragment.STICKY_HEIGHT1;
            }
    ...
    private void animScrollY() {
        ...
        if (thisScrollY == 0 || thisScrollY >= Child2Fragment.STICKY_HEIGHT1) {
            return;
        }

        int scrollY = 0;
        if (thisScrollY > Child2Fragment.STICKY_HEIGHT1 / 2) {
            scrollY = Child2Fragment.STICKY_HEIGHT1;
        }
